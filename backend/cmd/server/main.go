...
func main() {
	...
	defer repo.Close()
	notifier := service.NewGmailAPIInquiryNotifier(cfg.GmailClientID, cfg.GmailClientSecret, cfg.GmailRefreshToken, cfg.InquiryEmailFrom, cfg.InquiryNotificationTo)
